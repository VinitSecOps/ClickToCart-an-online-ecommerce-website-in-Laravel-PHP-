...
<div class="sl-mainpanel">
    ...
    <nav class="breadcrumb sl-breadcrumb">
        ...
        <span class="breadcrumb-item active">Custom date report</span>
    </nav>
            ...
            <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
                <div class="card bg-teal tx-white pd-25" style="width: 435%; max-height: 130px;">
                    <div class="d-flex align-items-center justify-content-between mg-b-10">
                        <h6 class="card-body-title tx-12 tx-white-8 tx-spacing-1">Total amount on {{ date('d F, Y',strtotime($date)) }}</h6>
