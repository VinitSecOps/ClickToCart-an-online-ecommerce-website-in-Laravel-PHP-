                ...
                <div class="col-lg-9">
                    ...
                    <div class="shop_content">
                        <div class="shop_bar clearfix">
                            <div class="shop_product_count"><span>{{ $categories_all->total() }}</span> products found</div>
                                    ...
                                    <li>
                                        <span class="sorting_text">
                                            ...
                                            @if (str_contains(Request::url(),"/name"))
                                                {{ "Name" }}
                                            @elseif (str_contains(Request::url(),"/low"))
                                                {{ "Low to high" }}
                                            @elseif (str_contains(Request::url(),"/high"))
                                                {{ "High to low" }}
                                            @endif
                                            <i class="fas fa-chevron-down">
                                        </span></i>
                                        <ul>
                                            <a href="{{ substr_replace(Request::url(),'name',strrpos(Request::url(),'/')+1) }}"><li class="shop_sorting_button"
                                                data-isotope-option='{ "sortBy": "original-order" }'>Name</li></a>
                                            <a href="{{ substr_replace(Request::url(),'low',strrpos(Request::url(),'/')+1) }}"><li class="shop_sorting_button" data-isotope-option='{ "sortBy": "name" }'>Low to high</li></a>
                                            <a href="{{ substr_replace(Request::url(),'high',strrpos(Request::url(),'/')+1) }}"><li class="shop_sorting_button" data-isotope-option='{ "sortBy": "price" }'>
                                                High to low</li></a>
                                        </ul>
                                    </li>
                                </ul>
