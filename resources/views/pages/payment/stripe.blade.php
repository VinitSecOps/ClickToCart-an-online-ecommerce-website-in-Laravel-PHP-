...
@section('content')
    ...
    <div class="contact_form">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 " style="border: solid white; padding: 20px;    height: 300px; border-radius: 25px;width: 250px;
                box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);
                ">
                    <div class="contact_form_container">
    ...
    <script type="text/javascript">
        ...
        var stripe = Stripe(
            'pk_test_51IkmXKSAxR6KhDcNR7HXWELgr16qmix8wxwciZGOTo1ebtkwMfLmvrVbrfvmRcescp6wYT9HQkJ6QMeLfV2Ll5Ox00fy7bufV7'
            );
