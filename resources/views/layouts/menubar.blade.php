                ...
                <div class="main_nav_content d-flex flex-row">
                    ...
                    <div class="cat_menu_container">
                        ...
                        <ul class="cat_menu">
                            ...
                            <li class="hassubs">
                                <a href="{{ url('allcategory/'.$row->id.'/name') }}">{{ $row->category_name }}<i class="fas fa-chevron-right"></i></a>
                                <ul>
                                    @php
                                    ...
                                    <li class="hassubs">
                                        <a href="{{ url('product/'.$row->id.'/name') }}">{{ $row->subcategory_name }}</a>
                                        @endforeach
                                </ul>
                            </li>
                            @endforeach
                    ...
                    <div class="main_nav_menu ml-auto">
                        <ul class="standard_dropdown main_nav_dropdown">
                            ...
                            <li><a href="{{ route('contact.page') }}">Contact us<i class="fas fa-chevron-down"></i></a></li>
                            <li><a href="{{ route('blog.post') }}">Blogs<i class="fas fa-chevron-down"></i></a></li>
                            <li><a href="{{ url('about/us') }}">About us<i class="fas fa-chevron-down"></i></a></li>
                        </ul>
                    </div>
