...
$(document).ready(function() {
    ...
    var menu = $('.sl-sideleft-menu');
    var item = menu.find('[href="' + window.location.href + '"]')[0];

    item.classList.add('active');

    var parent = item.parentElement.parentElement.previousElementSibling;

    if (parent.classList.contains('sl-menu-link')) {
